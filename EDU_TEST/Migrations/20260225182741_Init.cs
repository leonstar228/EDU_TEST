    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 2, 25, 18, 27, 41, 377, DateTimeKind.Utc).AddTicks(7844), "ivan@test.com", "Іван", "Петренко", "hash1", "Student" },
                    { 2, new DateTime(2026, 2, 25, 18, 27, 41, 377, DateTimeKind.Utc).AddTicks(7847), "maria@test.com", "Марія", "Коваль", "hash2", "Student" },
                    { 3, new DateTime(2026, 2, 25, 18, 27, 41, 377, DateTimeKind.Utc).AddTicks(7850), "tom@gmail.com", "Tom", "Admin", "73l8gRjwLftklgfdXT+MdiMEjJwGPVMsyVxe16iYpk8=", "Admin" }
                });
