    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 2, 25, 17, 59, 59, 879, DateTimeKind.Utc).AddTicks(6781), "ivan@test.com", "Іван", "Петренко", "hash1", "Student" },
                    { 2, new DateTime(2026, 2, 25, 17, 59, 59, 879, DateTimeKind.Utc).AddTicks(6784), "maria@test.com", "Марія", "Коваль", "hash2", "Student" },
                    { 3, new DateTime(2026, 2, 25, 17, 59, 59, 879, DateTimeKind.Utc).AddTicks(6786), "tom@gmail.com", "Tom", "Admin", "73l8gRjwLftklgfdXT+MdiMEjJwGPVMsyVxe16iYpk8=", "Admin" }
                });
